...
export const elements = {
    ...
    fileInfo: document.getElementById('canvas-file-badge'),
    btnRemoveFile: document.getElementById('btn-remove-file-badge'),
    btnChangeFile: document.getElementById('btn-change-file-badge'),
